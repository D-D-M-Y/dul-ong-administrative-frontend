...
export default function Page() {
  ...
  return (
      <div className="overflow-hidden bg-white w-full h-screen p-10 flex flex-col flex-grow bg-white justify-center items-center"> {/* Grid container with two columns */}
          ...
          <p className="text-textC font-ptsans font-normal text-base w-1/3 text-center">Password must contain one uppercase letter, one number, and be atleast 6 characters long.</p>
